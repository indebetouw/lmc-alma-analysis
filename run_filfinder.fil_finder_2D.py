...
fils=fil_finder_2D(fits_hdu, distance=distpc*u.pc, glob_thresh=50, flatten_thresh=90)
...
fils.create_mask(verbose=True, border_masking=False, adapt_thresh=55, size_thresh=300, use_existing_mask=False,save_png=True,smooth_size=2)
...
fils.analyze_skeletons(verbose=True, save_png=True, branch_thresh=30)
